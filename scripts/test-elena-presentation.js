...
assert.match(elenaSource, /ElenaConversationTurn/);
assert.match(elenaSource, />Visitor</);
assert.match(elenaSource, />Elena Cross</);
assert.match(elenaSource, /Approved public references/);
assert.match(elenaSource, /whitespace-pre-wrap/);
assert.match(elenaSource, /break-words/);
assert.match(elenaSource, /max-w-prose/);
