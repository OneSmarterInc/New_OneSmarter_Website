...
const modeCases = [
  ...
  },
  {
    ...
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludesAll: ["in development", "not yet an offered service", "Do not describe agent-assisted hiring as currently available."],
  },
  {
  ...
  },
  {
    ...
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludesAll: ["not yet an offered service", "Do not describe agent-assisted hiring as currently available."],
  },
  {
  ...
  },
  {
    ...
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludesAll: ["client-facing readiness support", "does not confirm OneSmarter's own ISO/IEC 27001 certification"],
  },
  {
    ...
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludesAll: ["readiness support", "does not confirm OneSmarter's own ISO/IEC 27001 certification"],
  },];
