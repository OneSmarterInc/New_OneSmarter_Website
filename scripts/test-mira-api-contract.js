...
const modeCases = [
  ...
  },
  {
    ...
    expectedAnswerExcludes: "OneSmarter is ISO/IEC 27001 certified",
  },
  {
    id: "iso-company-certification-unknown",
    env: { MIRA_LLM_MODE: "mock" },
    message: "Is OneSmarter ISO/IEC 27001 certified?",
    expectedMode: "local_harness_mock",
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludesAll: ["readiness support for clients", "not currently presenting OneSmarter certificate details or certification status"],
    expectedAnswerExcludes: "OneSmarter is ISO/IEC 27001 certified",
  },
  {
  ...
  {
    id: "iso-abbreviated-certification-placeholder",
    env: { MIRA_LLM_MODE: "mock" },
  ...
  },
  {
    ...
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludesAll: ["logo alone is not sufficient approved evidence", "not currently presenting OneSmarter certificate details"],
  },
  {
    ...
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludes: "not currently presenting OneSmarter certificate details",
  },
  {
  ...
  },
  {
    ...
    expectedHandoff: false,
    expectedStatus: 200,
    expectedAnswerIncludesAll: ["does not automatically certify a customer", "does not issue ISO certificates"],
  },
  {
