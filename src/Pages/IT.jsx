...
import Service1 from "../Images/laptop2.png";
import Service2 from "../Images/tech2.png";
  ...
  const services = [
    {
      ...
      description:
        "Offer short-term staffing solutions to cater to project-based needs, seasonal peaks, or to cover employee absences in IT departments.",
    },
    {
      image: Service2,
      title: "Permanent Staffing",
      description:
        "Provide long-term staffing solutions, helping companies find the perfect fit for their permanent IT roles including developers, analysts, and engineers.",
    },
    {
      image: Service1,
      title: "Contract-to-Hire Staffing",
      description:
        "Facilitate scenarios where a candidate begins as a contractor but has the potential to become a permanent employee based on performance.",
    },
    {
      image: Service2,
      title: "Executive Search",
      description:
        "Specialized service for finding high-level executives and specialized IT roles that require specific expertise like CTOs and IT Directors.",
    },
    {
      image: Service1,
      title: "Remote and Offshore Staffing",
      description:
        "Cater to the growing demand for remote and offshore IT professionals, connecting you with global talent pools.",
    },
    {
      image: Service2,
      title: "Training and Development",
      description:
        "Offer training programs for IT professionals to upgrade their skills in emerging technologies like AI, ML, and Data Analytics.",
    },
  ];
    ...
    <div className="min-h-screen bg-black relative pt-20 md:pt-24">
      ...
      <div className="pb-6 text-center">
        ...
        <p className="text-white/60 mt-2 text-sm md:text-base">
          Comprehensive IT staffing solutions for your business
        </p>
      </div>
