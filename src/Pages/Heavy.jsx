...
import Service1 from "../Images/S3.1.png";
import Service2 from "../Images/S3.2.png";
import Service3 from "../Images/S3.3.png";
import Service4 from "../Images/S3.4.png";
import Service5 from "../Images/S3.5.png";
  ...
  const services = [
    {
      ...
      description: "Providing labor for building commercial structures, bridges, roads, and large residential complexes."
    },
    {
      image: Service2,
      title: "Demolition Services",
      description: "Offering controlled demolition services for buildings, structures, and other facilities."
    },
    {
      image: Service3,
      title: "Heavy Machinery Operation",
      description: "Providing skilled operators for machinery like bulldozers, excavators, cranes, and backhoes."
    },
    {
      image: Service4,
      title: "Land Clearing and Grading",
      description: "Services for clearing land, leveling grounds, and preparing sites for construction or landscaping."
    },
    {
      image: Service5,
      title: "Concrete and Masonry Work",
      description: "Specializing in the construction of foundations, walls, sidewalks, and other concrete structures."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black relative pt-20 md:pt-24">
      ...
      <div className="pb-6 text-center">
        ...
        >
          Heavy Labour & Construction
        </h1>
        <p className="text-white/60 mt-2 text-sm md:text-base">Professional heavy-duty staffing solutions</p>
      </div>
