...
const Food = () => {
  ...
  const services = [
    {
      image: Service1,
      title: "Chef Placements",
      description: "Secure the expertise of our accomplished culinary professionals, from Executive Chefs who lead kitchen operations to skilled Sous Chefs, Line Cooks crafting culinary masterpieces, and creative Pastry Chefs bringing delightful sweet creations to your table."
    },
    {
      image: Service2,
      title: "Front-of-House Staffing",
      description: "Enhance the overall dining experience with our Front-of-House Staffing solutions. Our team of Servers ensures seamless service, Bartenders craft delightful beverages, Hosts/Hostesses welcome guests with warmth, and Food Runners ensure timely delivery."
    },
    {
      image: Service3,
      title: "Event Catering Teams",
      description: "Transform your events into culinary spectacles with our Event Catering Teams. Our talented Event Chefs design exquisite menus, Catering Managers coordinate flawless execution, Waitstaff deliver impeccable service."
    },
    {
      image: Service4,
      title: "Temporary Staffing Solutions",
      description: "Addressing short-term staffing demands effortlessly, our Temporary Staffing Solutions provide adaptable solutions. From Short-term Kitchen Staff to Seasonal Servers and Event Staffing tailored for peak periods."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black relative pt-20 md:pt-24">
      ...
      <div className="pb-6 text-center">
        ...
        <p className="text-white/60 mt-2 text-sm md:text-base">Meet your culinary needs with our staffing solutions</p>
      </div>
