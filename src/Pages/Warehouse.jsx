...
import Service1 from "../Images/S5.1.png";
import Service2 from "../Images/S5.2.png";
import Service3 from "../Images/S5.3.png";
import Service4 from "../Images/S5.4.png";
import Service5 from "../Images/S5.5.png";
...
const Warehouse = () => {
  ...
  const services = [
    {
      image: Service1,
      title: "Logistics and Supply Chain Specialists",
      description:
        "Staffing for roles requiring expertise in logistics, supply chain management, and transportation coordination.",
    },
    {
      image: Service2,
      title: "Training and Certification Programs",
      description:
        "Providing training services for warehouse workers, including safety training, equipment operation certification, and specialized skill development.",
    },
    {
      image: Service3,
      title: "Safety and Compliance Experts",
      description:
        "Offering staff who specialize in warehouse safety protocols and compliance with industry regulations.",
    },
    {
      image: Service4,
      title: "Customized Workforce Solutions",
      description:
        "Developing tailored staffing plans based on the specific needs of each client, considering factors like warehouse size, product types, and operational hours.",
    },
    {
      image: Service5,
      title: "Material Handlers",
      description:
        "Staffing for roles involving the moving, loading, and unloading of materials within or between warehouses.",
    },
  ];
    ...
    <div className="min-h-screen bg-black relative pt-20 md:pt-24">
      ...
      <div className="pb-6 text-center">
        ...
        <p className="text-white/60 mt-2 text-sm md:text-base">
          Professional warehouse staffing solutions
        </p>
      </div>
