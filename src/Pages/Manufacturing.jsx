...
import Service1 from "../Images/S4.1.png";
import Service2 from "../Images/S4.2.png";
import Service3 from "../Images/S4.3.png";
import Service4 from "../Images/S4.4.png";
import Service5 from "../Images/S4.5.png";
  ...
  const services = [
    {
      ...
      description:
        "Supplying temporary workers for short-term needs due to seasonal demand, employee absences, or special projects.",
    },
    {
      image: Service2,
      title: "Permanent Placement",
      description:
        "Assisting manufacturing companies in finding and hiring full-time, permanent staff for various roles.",
    },
    {
      image: Service3,
      title: "Skilled Labor Supply",
      description:
        "Providing skilled workers such as machinists, welders, fabricators, and maintenance technicians who have specific manufacturing skills.",
    },
    {
      image: Service4,
      title: "Assembly Line Workers",
      description:
        "Offering staffing for assembly line positions, which may require workers to have certain physical capabilities and the ability to work in a fast-paced environment.",
    },
    {
      image: Service5,
      title: "Quality Control Specialists",
      description:
        "Supplying staff trained in quality assurance and control, crucial for maintaining product standards in manufacturing.",
    },
  ];
    ...
    <div className="min-h-screen bg-black relative pt-20 md:pt-24">
      ...
      <div className="pb-6 text-center">
        ...
        <p className="text-white/60 mt-2 text-sm md:text-base">
          Professional manufacturing staffing solutions
        </p>
      </div>
