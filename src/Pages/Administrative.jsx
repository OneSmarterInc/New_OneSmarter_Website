...
import Service1 from "../Images/S1.1.png";
import Service2 from "../Images/S1.2.png";
import Service3 from "../Images/S1.3.png";
import Service4 from "../Images/S1.4.png";
import Service5 from "../Images/S1.5.png";
  ...
  const services = [
    {
      ...
      description: "Develop bespoke staffing plans based on the unique needs of each employer, including project-based, seasonal, or long-term staffing."
    },
    {
      image: Service2,
      title: "Workforce Management Tools",
      description: "Offer tools for tracking employee hours, managing shifts, and organizing workflows to help employers streamline their administrative processes."
    },
    {
      image: Service3,
      title: "Compliance and Legal Support",
      description: "Provide guidance on labor laws, workplace regulations, and compliance requirements specific to administrative roles."
    },
    {
      image: Service4,
      title: "Diversity and Inclusion Consulting",
      description: "Assist employers in creating a diverse and inclusive workplace, including strategies for inclusive hiring practices."
    },
    {
      image: Service5,
      title: "Performance Monitoring and Evaluation",
      description: "Offer services to help employers track and evaluate the performance of temporary or permanent staff."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black relative pt-20 md:pt-24">
      ...
      <div className="pb-6 text-center">
        ...
        <p className="text-white/60 mt-2 text-sm md:text-base">Our staffing solutions for your business</p>
      </div>
