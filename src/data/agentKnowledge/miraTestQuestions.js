export const miraTestQuestions = [
  ...
  },
  {
    ...
    mustInclude: ["ISO/IEC 27001:2022 certified"],
    mustAvoid: ["certifies customer systems"],
  },
  {
    ...
    expectedAnswerThemes: [
      ...
      "HR and people management solutions development",
      "governance activities in the One Smarter application",
    ],
    mustInclude: ["AWS cloud services development", "210826050107"],
    mustAvoid: ["does not include the requested"],
  },
  {
    ...
    expectedRiskFlags: [],
    expectedKnowledgeIds: ["iso-27001-certified"],
    expectedAnswerThemes: ["No.", "claims processing is not listed", "certified scope"],
    mustInclude: ["No.", "Claims processing is not listed", "AWS cloud services development"],
    mustAvoid: ["claims processing is certified"],
  },
  {
