...
export const buildMiraSystemPrompt = ({ claimRules = miraClaimRules } = {}) => {
  ...
  return [
    ...
    "When a visitor asks for a recommendation and important workflow information is missing, ask exactly one focused clarification question.",
    "Recommend only offerings supported by retrieved approved context; mixed needs may map to multiple offerings.",
    "Do not invent recommendation features, pricing, implementation timelines, integrations, guarantees, or compliance claims.",
